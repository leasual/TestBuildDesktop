...
class _$_LightState implements _LightState {
  ...
  @override
  String toString() {
    return 'LightState(etag: $etag, hascolor: $hascolor, manufacturer: $manufacturer, modelid: $modelid, name: $name, pointsymbol: $pointsymbol, state: $state, swversion: $swversion, type: $type, uniqueid: $uniqueid)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, etag, hascolor, manufacturer,
      modelid, name, pointsymbol, state, swversion, type, uniqueid);
...
abstract class _LightState implements LightState {
  const factory _LightState(
      ...
      final String? swversion,
      final String? type,
      final String? uniqueid}) = _$_LightState;
...
class _$_State implements _State {
  ...
  @override
  String toString() {
    return 'State(alert: $alert, bri: $bri, colormode: $colormode, ct: $ct, effect: $effect, hue: $hue, on: $on, reachable: $reachable, sat: $sat, xy: $xy)';
  }
